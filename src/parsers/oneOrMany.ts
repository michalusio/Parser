            ...
            while (true) {
                ...
                if (isFailure(resSep)) {
                    ...
                    if (surelyIndex >= 0) {
                        return {
                            ...resSep,
                            history:  ['oneOrMany', ...resSep.history.slice(0, surelyIndex), ...resSep.history.slice(surelyIndex + 1)]
                        };
                    }
                ...
                if (isFailure(res)) {
                    ...
                    if (surelyIndex >= 0) {
                        return {
                            ...res,
                            history: ['oneOrMany', ...res.history.slice(0, surelyIndex), ...res.history.slice(surelyIndex + 1)]
                        };
                    }
                    return success(ctx, results);
                }
